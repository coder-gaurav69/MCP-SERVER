...
export function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('mcp-manager.copyCopilotConfig', async () => {
 ...
 */
async function getPort(context) {
    const serverPath = await findServerPath(context);
    if (serverPath) {
 ...
 */
async function findServerPath(context) {
    ...
    const globalPath = config.get('serverPath');
